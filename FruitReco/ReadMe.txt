========================================================================
    ACTIVEX 控件 DLL : FruitReco 项目概述
========================================================================

控件向导已为 FruitReco ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 FruitReco ActiveX 控件 DLL 的每个文件的内容。
...
FruitRecoCtrl.h
    此文件包含 CFruitRecoCtrl C++ 类的声明。

FruitRecoCtrl.cpp
    此文件包含 CFruitRecoCtrl C++ 类的实现。

FruitRecoPropPage.h
    此文件包含 CFruitRecoPropPage C++ 类的声明。

FruitRecoPropPage.cpp
    此文件包含 CFruitRecoPropPage C++ 类的实现。

CFruitRecoCtrl.bmp
    此文件包含一个位图，当 CFruitRecoCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 FruitReco.pch 的预编译头 (PCH) 文件和名为 
